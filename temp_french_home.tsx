  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <nav className="hidden md:flex items-center gap-8">
              <Link href="/" className="text-cyan-400 font-semibold">ACCUEIL</Link>
              ...
              <Link href="/pricing" className="text-gray-300 hover:text-white transition-colors">TARIFS</Link>
              <div className="relative group">
                <button className="text-gray-300 hover:text-white transition-colors flex items-center gap-1">
                  RESSOURCES <ChevronRight className="w-4 h-4 rotate-90" />
                </button>
              </div>
            </nav>
            ...
            <Link href="/channels">
              <button className="bg-cyan-500 hover:bg-cyan-600 text-white px-6 py-2 rounded-md font-semibold transition-colors flex items-center gap-2">
                FORFAITS <ChevronRight className="w-4 h-4" />
              </button>
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-300 mb-2">Streaming TV en Direct</p>
              <p className="text-cyan-400 mb-8">Plus de 2400 Chaînes Disponibles</p>
              ...
              <div className="absolute -bottom-4 right-0 bg-black/80 backdrop-blur-sm px-6 py-3 rounded-lg border border-cyan-500">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-cyan-400">HD/4K</p>
                  </div>
                  <Tv className="w-8 h-8 text-cyan-400" />
                </div>
              </div>
      ...
      <section className="py-16 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold mb-4">PROGRAMMES POPULAIRES</h2>
          <p className="text-gray-400 mb-8">
            Des films à succès et des séries originales aux matchs en direct et aux sports pleins d&apos;action,
            TERRANOVISION vous propose les programmes les plus regardés en un seul endroit. Que vous aimiez les drames palpitants,
            les favoris de la famille ou le football de classe mondiale, il y en a toujours pour tous les goûts.
          </p>

          <h3 className="text-2xl font-bold mb-8 italic">meilleures plateformes de streaming</h3>
          ...
          {/* MOVIES AND SERIES */}
          <h3 className="text-2xl font-bold mb-8">FILMS ET SÉRIES</h3>
      ...
      {sportsChannels.length > 0 && (
        <section className="py-16 bg-gradient-to-b from-black to-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h3 className="text-2xl font-bold mb-8">CHAÎNES SPORTIVES</h3>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600 to-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold mb-4">Prêt à Commencer le Streaming ?</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">Votre destination pour le streaming TV en direct</p>
            </div>

            <div>
              <h4 className="font-bold mb-4">Produit</h4>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/channels" className="hover:text-cyan-400 transition-colors">Chaînes</Link></li>
                <li><Link href="/pricing" className="hover:text-cyan-400 transition-colors">Tarifs</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/auth/signin" className="hover:text-cyan-400 transition-colors">Connexion</Link></li>
                <li><Link href="/auth/signup" className="hover:text-cyan-400 transition-colors">Inscription</Link></li>
              </ul>
            </div>
